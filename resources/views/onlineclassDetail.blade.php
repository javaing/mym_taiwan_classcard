...
{{
        $arrIn = DBHelperOnline::getCardHistoryOnline($cardId);
        $arrOut = DBHelperOnline::getConsumeByCardOnline($cardId);
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a id='refundbtn' href="{{ route('onlineclass.refund', ['cardId' => base64_encode($cardId), 'amount'=>$sumIn-$sumOut]) }}" class="btn btn-primary">確認</a>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal -->
    </div>
